// "Easy" and "Hard" buttons are only active when no game is in progress (when startBtn is enabled). When user clicks on "Easy" or "Hard" buttons, the button background-color changes and a boolean variable is assigned to store the active difficulty mode.
